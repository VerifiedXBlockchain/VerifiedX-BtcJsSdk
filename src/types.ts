...
declare global {
  interface Window {
    btc: {
      KeypairService: typeof import('./btc/keypair').default
      TransactionService: typeof import('./btc/transaction').default
      AccountService: typeof import('./btc/account').default
